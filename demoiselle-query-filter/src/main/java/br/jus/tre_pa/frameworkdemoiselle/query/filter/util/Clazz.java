 ...
 * http://www.pa.muiraquita.gov.br/, 1968-2008. Todos os direitos reservados.
 * 
 * A redistribui��o e utiliza��o � restrita ao uso interno da PRODEPA em suas
 * depend�ncias, salvo cedido a alguma outra entidade da esfera municipal,
 * estadual ou federal, o que deve ser uma permiss�o fornecida por escrito, com
 * caracter�sticas legais, registrado no sistema de protocolo do Estado do Par�.
 */
...
/**
 * Classe utilit�ria para auxiliar no uso da API Reflection do Java.
